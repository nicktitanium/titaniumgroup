...
func InitLogger(pathToLogFile string) {

	logFile, err := os.OpenFile(pathToLogFile, os.O_APPEND|os.O_WRONLY|os.O_CREATE, 0666)

	if err != nil {
		logrus.Fatal("info: can't open/create log file")
	}
